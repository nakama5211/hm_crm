			    ...
			    <div class="row" style="margin-top: 50px;">
			    	...
			    	<div class="col-md-7">
						    <div style="float: right;">
								<button type="button" class="fc-agendaWeek-button fc-button fc-state-default fc-state-active fc-corner-right"  data-toggle="modal" data-target="#myModal">Thêm</button>
							</div>
			    	</div>
			    </div>
  ...
  <div class="modal-dialog" role="document" style="margin-top: 8%">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Thêm trường dữ liệu người dùng</h4>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="insertExtUser('user')">Thêm</button>
      </div>
    </div>
  </div>
</div>